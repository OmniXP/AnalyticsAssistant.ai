...
echo "CHATGPT_REDIRECT_URI_ALLOWLIST=https://chat.openai.com,https://chatgpt.com"
...
echo "-------------------"
echo "1. Generate OAuth credentials:"
echo "   - Run: node scripts/generate-chatgpt-credentials.js"
echo "   - Copy the output to your .env file"
echo ""
echo "2. Configure your GPT in ChatGPT (not OpenAI platform):"
echo "   - Go to ChatGPT → Explore GPTs → Create"
echo "   - Upload openapi.json from web/pages/api/chatgpt/openapi.json"
echo "   - Set OAuth URLs (see docs/GPT_ACTIONS_OAUTH_CORRECT.md)"
echo ""
echo "2. Test locally:"
